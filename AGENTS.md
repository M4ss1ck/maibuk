...
| `getDefaultBackupDirectory()` / `allowBackupDirectory()` (displayed backup folder; desktop filesystem grant for a typed one)                                                                                                                   | `src/lib/platform/index.ts`                                            |
| `computeChecksum()`                                                                                                                                                                                                                            | `src/lib/checksum.ts`                                                  |
| `parseTriggerFromFilename()` / `formatBackupDate()`                                                                                                                                                                                                                   | `src/features/backup/utils.ts`                                         |
