    ...
    <div className="p-8">
      ...
      {books.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          <div className="w-24 h-24 mb-6 rounded-full bg-[var(--color-border)] flex items-center justify-center">
            <svg className="w-12 h-12 text-[var(--color-muted)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
